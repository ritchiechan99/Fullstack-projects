...
export default class Preloader extends EventEmitter {
    ...
    //     convert(document.querySelector(".dark-panel"));
    ...
    firstIntro() {
        ...
        console.log("done setting 2"); 
        // document.querySelector(".dark-panel").addEventListener('click', () => {
        //     darkPanel.style.opacity = '1'; // Set opacity to 1 for fade-in effect
        // });
    ...
    secondIntro() {
        return new Promise((resolve) => {
            ...
            this.secondTimeline
                ...
                .to(
                    this.roomChildren.poster_1.scale,
                    {
                        x: 2,
                        y: 1,
                        z: 1,
                ...
                .to(
                    this.roomChildren.poster_2.scale,
                    {
                        x: 3,
                        y: 3,
                        z: 3,
                ...
                .to(
                    this.roomChildren.table_stufff.scale,
                    {
                        x: 1,
                        y: 1,
                        z: 1,
